...
from tg_bot.handlers import register_start, register_profile_back, \
     ...
     register_uploading_file, register_choose_list, register_callback_choose_list
...
def register_all_handlers(dp):
    ...
    register_uploading_file(dp)
    register_choose_list(dp)
    register_callback_choose_list(dp)
